...
_MODELS = {
    "videomambapro_t16_in1k": os.path.join(MODEL_PATH, "videomambapro_t16_in1k_res224.pth"),
    "videomambapro_s16_in1k": os.path.join(MODEL_PATH, "videomambapro_s16_in1k_res224.pth"),
    "videomambapro_m16_in1k": os.path.join(MODEL_PATH, "videomambapro_m16_in1k_res224.pth"),
}
